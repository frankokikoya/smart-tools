...
const ThreeColumn = ({ id, index, moveColumn, content = [], parent }) => {
            ...
            if (selectedRow?.id === id) {
                ...
                setSelectedRow(prev => {
                    return {
                        ...
                        id,
                        index,
                        typeColumn: typeColumn.THREE_COLUMN,
                        parent
                    };
                });
            }
    ...
    return (
        <Box
            ...
            <ColumnDropZone
                ...
                parent={parent}
                index={index}
                side={sideContent.CENTER}
                content={content.filter(c => c.side === sideContent.CENTER)} />
            <ColumnDropZone
                width='33%'
                parent={parent}
                index={index}
